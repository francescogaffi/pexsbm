...
alpha0  <- 14
lambda0 <- 2
expnumcl_hdpgamma(N,alpha, lambda, alpha0, lambda0,2000)
...
save(waic, vi, expected_vi, vi_bound, z_estimated, H_estimated, H_posterior,file="output_HDP_hyperprior.RData")
